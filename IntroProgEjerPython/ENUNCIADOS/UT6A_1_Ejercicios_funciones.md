...
Función `calcula_ganancias_uva(precio_kilo, kilos, tipo)` que recibe el precio por kilo en euros *precio_kilo*, la cantidad de kilos *kilos* y el tipo de uva *tipo* y devuelve las ganancias del vinicultor en euros.
...
Función `coste_llamada(tiempo, es_domingo)` que recibe el tiempo que dura una llamada en minutos *tiempo* y una cadena 'S' o 'N' indicando si la llamada se ha hecho en domingo o no *es_domingo* y devuelve el coste de la llamada.
