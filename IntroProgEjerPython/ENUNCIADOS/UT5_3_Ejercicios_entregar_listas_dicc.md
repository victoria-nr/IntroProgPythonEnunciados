...
## Ejercicio 7
Ejercicio 7: Usa la librería `pathlib` para listar los usuarios en `/home`. Crea un diccionario con su nombre y cuántos archivos tienen en su carpeta de usuario. Muestra el contenido del diccionario recorriendo sus elementos. 
